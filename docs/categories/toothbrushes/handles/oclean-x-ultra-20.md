...
Model / fitment code: `V8100` · Mode: sonic · Charging: inductive · Status: unknown
...
Oclean lists the certified model name as V8100. This identifies the
manufacturer model; widespread aftermarket use of that code is unverified.

## Sources

- <https://eu.oclean.com/products/x-ultra-20-sonic-toothbrush>
