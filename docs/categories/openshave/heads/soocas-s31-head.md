---
source_yaml: data/openshave/heads/soocas-s31-head.yml
---

<!-- generated from data/. Do not hand-edit; run tools/build_pages.py -->

# Soocas S31 Replacement Head

OEM · Heads: 3 · Type: rotary · Material: stainless-steel · Variant: original

Also sold as: Soocas S31 replacement shaver head, 素士 S31 剃须刀刀头
...
[Suggest a correction or addition](https://github.com/openconsumables/openconsumables.github.io/issues/new?template=evidence-report.md&title=Reference%3A+soocas-s31-head&body=Device%2Fpart+or+page%3A+openshave%2Fheads%2Fsoocas-s31-head+%28https%3A%2F%2Fopenconsumables.org%2Fcategories%2Fopenshave%2Fheads%2Fsoocas-s31-head%2F%29%0ACorrection+or+addition%3A+%0ASource%3A+%0AUncertainty%3A+%0A) (GitHub sign-in required). One sourced fact helps; better sources and conflicting fit evidence are welcome. For a broken link or an unverified claim, just identify the problem.

[Copy a report without GitHub](../../../contributing.md#send-a-short-report) or [inspect the source YAML](https://github.com/openconsumables/openconsumables.github.io/blob/master/data/openshave/heads/soocas-s31-head.yml).
