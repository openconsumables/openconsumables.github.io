...
# ShowSee F1 / F303-BK Replacement Head

OEM · Heads: 3 · Type: rotary · Material: stainless-steel · Variant: original

Also sold as: 小适电动剃须刀 F1/F303-BK 通用替换刀头, F1/F303-BK 剃须刀通用刀头
...
Shared head for ShowSee F1-BK and F303-BK per a ZOL / JD deal page.
No public head SKU captured. The cross-fit claim is marketplace-
claim only.
