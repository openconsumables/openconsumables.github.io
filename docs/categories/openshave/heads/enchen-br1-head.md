...
Also sold as: ENCHEN BR-1, ENCHEN BlackStone Shaver Blade, BR-1 replacement head
...
ENCHEN BR-1 head-code anchor. Listed by Galaxus, MiOT Global, Pepita,
Aquario, Shopmobile, and Yorkshire as the replacement head for the
BlackStone, BlackStone-C, and Warrior bodies. Code appears as
product title, article number, reference, EAN 6974728531341. The
`oem: true` flag reflects the head being ENCHEN-branded and sold
under one consistent code, but the fitment list is multi-retailer
marketplace-claim, not a captured ENCHEN brand-site replacement-
head page (which would upgrade it to manufacturer-claim).
...
- <https://pepita.com/en/electric-shaving-heads-c5181/enchen-interchangeable-blade-for-blackstone-blackstone-c-warrior-razor-br-1-p8385844>
