...
# ShowSee T3 Replacement Head

OEM · Heads: 3 · Type: magnetic-rotary · Material: stainless-steel · Variant: original

Also sold as: 小适智能剃须刀 T3 刀头, 剃须刀刀头·T3, 磁吸式刀头组件
...
ShowSee T3 replacement head from Huawei Vmall. The product title
says the head fits standard edition, premium edition, and T3, which
is a within-T3-family cross-fit rather than a broad ShowSee anchor.
Magnetic quick-release retention ("磁吸式刀头组件") is the headline
retention feature.
