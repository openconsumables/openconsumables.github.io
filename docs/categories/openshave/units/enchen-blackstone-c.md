---
source_yaml: data/openshave/units/enchen-blackstone-c.yml
---
...
Also sold as: ENCHEN BlackStone C, ENCHEN BlackStone-C
...
Strongest head-code anchor in the OpenShave cluster. Export retailers
(Galaxus, Pepita, Shopmobile, MiOT Global, Aquario) list BR-1 as the
replacement head for ENCHEN BlackStone, BlackStone-C, and Warrior; the
code appears in product titles, reference fields, and article-number
fields. Chinese official-channel evidence for BR-1 was not captured in
the desk pass, so the manufacturer-level fitment list is marketplace-
claim, not manufacturer-claim. One source had inconsistent prose
mentioning a "Warrior BR-2"; treat as seller noise pending verification.

## Notes

Second member of the ENCHEN BR-1 family per export retailer titles. No
separate ENCHEN brand-site product page for BlackStone-C was captured
in the desk pass; the unit's existence and BR-1 head fit are
marketplace-claim only.
...
[Suggest a correction or addition](https://github.com/openconsumables/openconsumables.github.io/issues/new?template=evidence-report.md&title=Reference%3A+enchen-blackstone-c&body=Device%2Fpart+or+page%3A+openshave%2Funits%2Fenchen-blackstone-c+%28https%3A%2F%2Fopenconsumables.org%2Fcategories%2Fopenshave%2Funits%2Fenchen-blackstone-c%2F%29%0ACorrection+or+addition%3A+%0ASource%3A+%0AUncertainty%3A+%0A) (GitHub sign-in required). One sourced fact helps; better sources and conflicting fit evidence are welcome. For a broken link or an unverified claim, just identify the problem.

[Copy a report without GitHub](../../../contributing.md#send-a-short-report) or [inspect the source YAML](https://github.com/openconsumables/openconsumables.github.io/blob/master/data/openshave/units/enchen-blackstone-c.yml).
